exports .convert_to_unicode = function(pathako) {
    ...
    var modified_substring = pathako;
    var text_size = pathako.length;
    var processed_text = '';
    var sthiti1 = 0;
    var sthiti2 = 0;
    var chale_chalo = 1;
    ...
    while (chale_chalo == 1) {
        ...
        var modified_substring = pathako.substring(sthiti1, sthiti2);
        Replace_Symbols();
        processed_text += modified_substring;
        let unicode = processed_text;
        return unicode;
        // console.log(unicode)
    }
...
// let string = "xfd|f] b]z g]kfndf slt c~rn 5g\ < "
